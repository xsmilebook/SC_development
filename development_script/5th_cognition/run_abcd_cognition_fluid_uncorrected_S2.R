...
in_rds <- file.path(resultFolder, paste0("SC_Cog_results_", Cogvar, "_CV", CVthr, "_cognition.rds"))
if (!file.exists(in_rds)) {
  stop("Missing S1 output: ", in_rds, "\nRun first: Rscript development_script/5th_cognition/run_abcd_cognition_fluid_uncorrected_S1.R")
}
...
## 2) Distribution of significant correlations
