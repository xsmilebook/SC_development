...
saveRDS(SCrank.df, file.path(resultFolder, paste0("SCrankcorr_change_score_", Cogvar_base, "_CV", CVthr, ".rds")))
...
ggsave(file.path(resultFolder, paste0("scatter_beta_vs_SCrank_change_score_", Cogvar_base, "_CV", CVthr, ".pdf")), scatterFig, width = 12, height = 10, units = "cm", bg = "transparent")
ggsave(file.path(resultFolder, paste0("scatter_beta_vs_SCrank_change_score_", Cogvar_base, "_CV", CVthr, ".tiff")), scatterFig, width = 12, height = 10, units = "cm", bg = "transparent", dpi = 600)
