...
saveRDS(SCrank.df.t, file.path(resultFolder, paste0("SCrankcorr_lmm_time_by_", Cogvar_base, "_CV", CVthr, "_tvalue.rds")))
...
ggsave(file.path(FigureFolder, paste0("scatter_tvalue_vs_SCrank_lmm_", Cogvar_base, "_CV", CVthr, ".pdf")), scatterFig.t, width = 12, height = 10, units = "cm", bg = "transparent")
ggsave(file.path(FigureFolder, paste0("scatter_tvalue_vs_SCrank_lmm_", Cogvar_base, "_CV", CVthr, ".tiff")), scatterFig.t, width = 12, height = 10, units = "cm", bg = "transparent", dpi = 600)
