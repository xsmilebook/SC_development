## Chinese Cohort (ComBat-GAM) | Derivatives from scaled GAM models
##
## Inputs are expected from:
##   outputs/intermediate/2nd_fitdevelopmentalmodel/chinese/combat_gam/CV75/
## and outputs are written to:
##   outputs/results/2nd_fitdevelopmentalmodel/chinese/combat_gam/CV75/
##
## Usage (examples):
##   Rscript --vanilla development_script/2nd_fitdevelopmentalmodel/S2nd_calculatederivative_ChineseCohort_combatgam.R
##   Rscript --vanilla .../S2nd_calculatederivative_ChineseCohort_combatgam.R --skip_posterior=1 --n_edges=10
