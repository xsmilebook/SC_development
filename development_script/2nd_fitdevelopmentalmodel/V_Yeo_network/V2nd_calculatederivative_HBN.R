...
if (str_detect(wdpath, "cuizaixu_lab")){
  ...
  resultFolder <- '/ibmgpfs/cuizaixu_lab/xuxiaoyu/SC_cdevelopment/results_HBN'
}else{
...
#### load data
CVthr = 75
gamresultsum<-readRDS(paste0(interfileFolder, '/gamresults_Yeo', elementnum, '_sumSCinvnode_CV', CVthr,'.rds'))
