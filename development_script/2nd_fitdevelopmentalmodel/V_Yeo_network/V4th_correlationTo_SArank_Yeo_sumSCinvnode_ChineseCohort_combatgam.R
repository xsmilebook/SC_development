...
interfileFolder <- file.path(
  ...
  "chinese", "yeo", paste0("Yeo", yeo), "combat_gam", paste0("CV", CVthr)
)
resultFolder <- file.path(
  project_root, "outputs", "results", "2nd_fitdevelopmentalmodel",
  "chinese", "yeo", paste0("Yeo", yeo), "combat_gam", paste0("CV", CVthr)
)
FigureRoot <- file.path(project_root, "outputs", "figures", "2nd_fitdevelopmentalmodel", "chinese", "yeo", paste0("Yeo", yeo), "combat_gam", paste0("CV", CVthr))
