...
summary(gamresultsum.df$sig) # Yeo17 84 edges significant
saveRDS(gamresultsum.df, paste0(interfileFolder, '/gamresults_Yeo', elementnum, '_sumSCinvnode_CV', CVthr,'.rds'))
...
saveRDS(resultsum, paste0(interfileFolder, '/gammodel_Yeo', elementnum, '_sumSCinvnode_CV', CVthr,'.rds'))
...
saveRDS(resultsum, paste0(interfileFolder, '/gammodel_Yeo', elementnum, '_sumSCinvnode_CV', CVthr,'_scale_TRUE.rds'))
...
gamresultsum.df$pfdr<- p.adjust(gamresultsum.df$anova.smooth.pvalue, method = "fdr")
gamresultsum.df$sig<-(gamresultsum.df$pfdr<0.05)
saveRDS(gamresultsum.df, paste0(interfileFolder, '/gamresults_Yeo', elementnum, '_sumSCinvnode_CV', CVthr,'_scale_TRUE.rds'))
