## Chinese Cohort (ComBat-GAM) | Yeo7/Yeo17 | Derivatives from scaled GAM models
##
## Inputs:
## - outputs/intermediate/2nd_fitdevelopmentalmodel/chinese/yeo/Yeo{7,17}/combat_gam/CV75/gammodel_Yeo*_scale_TRUE.rds
##
## Outputs:
## - outputs/results/2nd_fitdevelopmentalmodel/chinese/yeo/Yeo{7,17}/combat_gam/CV75/*
##
## Usage:
##   Rscript --vanilla .../V2nd_calculatederivative_ChineseCohort_combatgam.R --yeo=7
##   Rscript --vanilla .../V2nd_calculatederivative_ChineseCohort_combatgam.R --yeo=17 --skip_posterior=1
