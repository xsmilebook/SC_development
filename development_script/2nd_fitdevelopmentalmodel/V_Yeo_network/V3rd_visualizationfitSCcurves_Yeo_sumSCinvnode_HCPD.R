...
#### load data
CVthr = 75
gamresultsum.Yeo.delLM<-readRDS(paste0(interfileFolder, '/gamresults_Yeo',elementnum,'_sumSCinvnode_over8_CV', CVthr,'_scale_TRUE.rds'))
gammodelsum<-readRDS(paste0(interfileFolder, '/gammodel_Yeo',elementnum,'_sumSCinvnode_over8_CV', CVthr,'_scale_TRUE.rds'))
...
#saveRDS(plotdatasum, paste0(interfileFolder, "/plotdatasum_scale_TRUE_Yeo", Yeoresolution,"_50.rds"))
...
ggsave(paste0(FigureFolder, '/CV',CVthr, '/Yeo', Yeoresolution, '_sumSCinvnode_fit/devcurve_Rsq_fit.ratio.tiff'), width=15, height =14, units = "cm")
ggsave(paste0(FigureFolder, '/CV',CVthr, '/Yeo', Yeoresolution, '_sumSCinvnode_fit/devcurve_Rsq_fit.ratio.svg'), dpi=600, width=15, height =12, units = "cm")
...
ggplot()+
  geom_line(data=plotdatasum.df, aes(x=age, y=fit.Z, group=SC_label2, color=SCrank), size=0.8, alpha=0.8)+
...
ggsave(paste0(FigureFolder, '/CV',CVthr, '/Yeo', Yeoresolution, '_sumSCinvnode_fit/devcurve_SCrank_fit.Z.tiff'), width=15, height =14, units = "cm")
