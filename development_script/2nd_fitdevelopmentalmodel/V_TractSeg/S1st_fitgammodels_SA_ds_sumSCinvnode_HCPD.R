...
if (str_detect(wdpath, "cuizaixu_lab")){
  ...
  saveRDS(gamresultsum.df, paste0(interfileFolder, '/gamresults', elementnum, '_sumSCinvnode_over8_CV', CVthr,'_TractSeg.rds'))
}else{gamresultsum.df <- readRDS(paste0(interfileFolder, '/gamresults', elementnum, '_sumSCinvnode_over8_CV', CVthr,'_TractSeg.rds'))}
...
if (str_detect(wdpath, "cuizaixu_lab")){
  ...
  saveRDS(resultsum, paste0(interfileFolder, '/gammodel', elementnum, '_sumSCinvnode_over8_CV', CVthr,'_TractSeg.rds'))
}else{resultsum <- readRDS(paste0(interfileFolder, '/gammodel', elementnum, '_sumSCinvnode_over8_CV', CVthr,'_TractSeg.rds'))}
...
if (str_detect(wdpath, "cuizaixu_lab")){
  ...
  saveRDS(plotdatasum.df, paste0(interfileFolder, '/plotdatasum.df_SA', ds.resolution,'_sumSCinvnode_CV', CVthr,'_TractSeg.rds'))
}else{plotdatasum.df <- readRDS(paste0(interfileFolder, '/plotdatasum.df_SA', ds.resolution,'_sumSCinvnode_CV', CVthr,'_TractSeg.rds'))}
...
saveRDS(SCdata.diw, paste0(interfileFolder, "/SCdata.diw_SA", ds.resolution,"CV", CVthr, "_TractSeg.rds"))
if (str_detect(wdpath, "cuizaixu_lab")){
  covariates<-"sex+mean_fd"
  dataname<-"SCdata.diw"
  smooth_var<-"age"
  ...
  saveRDS(resultsum, paste0(interfileFolder, '/gammodel', elementnum, '_sumSCinvnode_over8_CV', CVthr,'_scale_TRUE_TractSeg.rds'))
}else{resultsum <- readRDS(paste0(interfileFolder, '/gammodel', elementnum, '_sumSCinvnode_over8_CV', CVthr,'_scale_TRUE_TractSeg.rds'))}
...
if (str_detect(wdpath, "cuizaixu_lab")){
  ...
  saveRDS(gamresultsum.df, paste0(interfileFolder, '/gamresults', elementnum, '_sumSCinvnode_over8_CV', CVthr,'_scale_TRUE_TractSeg.rds'))
}else{gamresultsum.df <- readRDS(paste0(interfileFolder, '/gamresults', elementnum, '_sumSCinvnode_over8_CV', CVthr,'_scale_TRUE_TractSeg.rds'))}
