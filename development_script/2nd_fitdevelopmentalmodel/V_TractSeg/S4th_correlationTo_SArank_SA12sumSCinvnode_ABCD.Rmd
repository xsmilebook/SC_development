...
ggsave(paste0(FigureFolder,'/correlation_sumSCinvnode_SCrank/mean', computevar, '_SCrankcorr_siteall.tiff'), width=mywidth, height =myheight, units = "cm")
ggsave(paste0(FigureFolder,'/correlation_sumSCinvnode_SCrank/mean', computevar, '_SCrankcorr_siteall.svg'), dpi=600, width=mywidth, height =myheight, units = "cm")
