...
## - outputs/results/2nd_fitdevelopmentalmodel/chinese/yeo/Yeo{7,17}/combat_gam/CV75/derivative.posterior.df.Yeo{7,17}_CV75.rds
##
## Outputs:
## - outputs/results/4th_changerate_SAcorr/chinese/yeo/Yeo{7,17}/combat_gam/CV75/alignment_*.csv*
## - outputs/figures/4th_changerate_SAcorr/chinese/yeo/Yeo{7,17}/combat_gam/CV75/Alignment_development/*.tiff + *.pdf
##
## Usage:
...
if (is_windows) {
  save_svg_if_available(file.path(figure_dir, paste0("Yeo", yeo, "_posDeriv_divweight_corr.svg")), p_align, width_cm = 13.5, height_cm = 13.5)
  save_svg_if_available(file.path(figure_dir, paste0("Agedistribution_0corr_Yeo", yeo, ".svg")), p_hist, width_cm = 6, height_cm = 6)
}
