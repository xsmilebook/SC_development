...
## - outputs/intermediate/2nd_fitdevelopmentalmodel/hcpd/yeo/Yeo{7,17}/combat_gam/CV75/SCdata.diw_Yeo{7,17}CV75.rds
## - outputs/results/4th_changerate_SAcorr/hcpd/yeo/Yeo{7,17}/combat_gam/CV75/alignment_summary_flip_age.csv
##
## Outputs:
## - outputs/intermediate/4th_changerate_SAcorr/hcpd/yeo/Yeo{7,17}/combat_gam/CV75/gamresults*_Yeo*_*.rds
## - outputs/figures/4th_changerate_SAcorr/hcpd/yeo/Yeo{7,17}/combat_gam/CV75/correlation_sumSCinvnode_SCrank_{younger,older}/*.tiff + *.pdf
##
## Usage:
