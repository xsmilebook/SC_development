...
if (str_detect(wdpath, "cuizaixu_lab")){
  ...
  FigureFolder <- paste0('/ibmgpfs/cuizaixu_lab/xuxiaoyu/SC_development/Figure_ChineseCohort_final/Yeo', Yeoresolution)
...
Age.0.corr.diw.median # 14.99 (Yeo7) 14.70792 (Yeo17)
Age.0.corr.diw.CI # 14.23 16.84 (Yeo7) 14.22971 15.52129 (Yeo17)
...
ggsave(paste0(FigureFolder,'/CV', CVthr, '/Alignment_development/Yeo', Yeoresolution, '_posDeriv_divweight_corr.tiff'), width=13, height=12.5, units="cm")
