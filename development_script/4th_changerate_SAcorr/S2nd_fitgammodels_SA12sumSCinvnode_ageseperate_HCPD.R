...
##
## Purpose:
## - Split HCP-D (scaled) SC edges into younger/older groups at the flip age.
...
##
## Outputs:
## - outputs/intermediate/4th_changerate_SAcorr/hcpd/combat_gam/CV75/gamresults78_sumSCinvnode_over8_CV75_{young,old}.rds
## - outputs/intermediate/4th_changerate_SAcorr/hcpd/combat_gam/CV75/gammodel78_sumSCinvnode_over8_CV75_{younger,older}.rds
## - outputs/figures/4th_changerate_SAcorr/hcpd/combat_gam/CV75/{correlation_sumSCinvnode_SCrank_younger,...}/*.tiff (+svg if svglite)
##
## Usage:
##   Rscript --vanilla development_script/4th_changerate_SAcorr/S2nd_fitgammodels_SA12sumSCinvnode_ageseperate_HCPD.R
