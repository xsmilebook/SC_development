...
if (is_windows) {
  save_svg_if_available(file.path(figure_dir, "SA12_posDeriv_SAaxis_alignment.svg"), p_align, width_cm = 16, height_cm = 15)
  save_svg_if_available(file.path(figure_dir, "Flip_age_histogram.svg"), p_hist, width_cm = 14, height_cm = 10)
}
