...
write.csv(res_all, file.path(resultFolder, paste0("age_lmm_random_slope_results_all_", Pvar_base, "_CV", CVthr, out_suffix, ".csv")), row.names = FALSE)
...
ggsave(file.path(FigureFolder, paste0("scatter_fixed_age_vs_SCrank_", Pvar_base, "_CV", CVthr, out_suffix, ".tiff")), p_fixed, width = 15, height = 15, units = "cm", bg = "transparent")
ggsave(file.path(FigureFolder, paste0("scatter_fixed_age_vs_SCrank_", Pvar_base, "_CV", CVthr, out_suffix, ".pdf")), p_fixed, width = 15, height = 15, units = "cm", bg = "transparent")
...
ggsave(file.path(FigureFolder, paste0("scatter_random_age_vs_SCrank_", Pvar_base, "_CV", CVthr, out_suffix, ".tiff")), p_rand, width = 15, height = 15, units = "cm", bg = "transparent")
ggsave(file.path(FigureFolder, paste0("scatter_random_age_vs_SCrank_", Pvar_base, "_CV", CVthr, out_suffix, ".pdf")), p_rand, width = 15, height = 15, units = "cm", bg = "transparent")
...
plot_matrix(mat_rand_low, "Random age effect (low10)", file.path(FigureFolder, paste0("matrix_random_age_low10_", Pvar_base, "_CV", CVthr, out_suffix)))
plot_matrix(mat_rand_high, "Random age effect (high10)", file.path(FigureFolder, paste0("matrix_random_age_high10_", Pvar_base, "_CV", CVthr, out_suffix)))
