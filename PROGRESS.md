...
- 2026-02-02: age LMM cognition/pfactor 的 decile 柱状图回退为单图 10 组柱状，并新增随机斜率 decile 柱状图。
...
- 2026-02-05: 中国队列 SA7/SA17 devmodel/changerate 默认跳过 Euclidean distance 控制（新增 `skip_euclid` 分支与 sbatch 参数）。
