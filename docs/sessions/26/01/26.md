...
## 追加：ABCD plotdata 统一使用项目内路径
- `ABCD_PLOTDATASUM_RDS` 默认改为 `outputs/intermediate/2nd_fitdevelopmentalmodel/abcd/combat_gam/CV75/plotdatasum.df_SA12_sumSCinvnode_siteall_CV75.rds`，并同步到对应 sbatch 与脚本。
