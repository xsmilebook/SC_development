...
- `development_script/5th_cognition/run_abcd_age_lmm_random_slope_cognition_groups.R`：decile 柱状图移除 decile 图注，仅保留 group 图注并置于右上角（High/Low level），low 组保留黑色虚线阴影。
